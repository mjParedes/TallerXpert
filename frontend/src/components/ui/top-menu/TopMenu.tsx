...
export const TopMenu = () => {
  ...
  const routeConfig = {
    '/dashboard': { icon: <DashboardTop />, title: 'Dashboard' },
    '/dashboard/technicians': { icon: <TechniciansTop />, title: 'Técnicos' },
    '/dashboard/orders': { icon: <OrdersTop />, title: 'Ordenes' },
    '/dashboard/suppliers': { icon: <SuppliersTop />, title: 'Proveedores' },
    '/dashboard/statistics': { icon: <StatisticsTop />, title: 'Estadísticas' },
    '/dashboard/workshop': { icon: <WorkshopTop />, title: 'Taller' }
  }
  const currentRouteConfig = routeConfig[pathName as keyof typeof routeConfig] || { icon: null, title: '' }
...
//           <h2 className="text-base font-semibold text-gray-900">{userName}</h2>
//         </div>
//         <Image src={userImage} alt={userName} className="object-cover w-12 h-12 m-auto rounded-full" width={150} height={150} />
