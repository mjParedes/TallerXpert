...
export async function getMerchantOrder(id: number, clienteEmail: string) {
    ...
    await sendEmailWithAttachment(clienteEmail, externalReference, orderStatus, false);
...
async function sendEmailWithAttachment(destinatarioEmail: string, externalReference: string, orderStatus: string, isAdmin: boolean) {
